...
const posts = [
  { image: 'assets/instagram/01-before-kotex.png', alt: '靠得住草本抑菌衛生棉合作貼文範例一', caption: '出發前的迎新福袋，我們想把日常照顧一起準備好。若合作成案，靠得住草本抑菌衛生棉將依品牌確認方式放入女同學的福袋。', label: '貼文方向一｜活動前' },
  ...
  { image: 'assets/instagram/03-after-kotex.png', alt: '靠得住草本抑菌衛生棉合作貼文範例三', caption: '三天兩夜結束後，福袋裡留下的是實用的日常用品和認識新朋友的回憶。實際合作露出與商品資訊均以靠得住最終確認為準。', label: '貼文方向三｜活動後' },
];
let currentPost = 0;
