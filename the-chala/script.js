...
const posts = [
  { image: 'assets/instagram/01-before.png', alt: '蕎拉燕麥 The Chala 合作貼文範例一', caption: '活動前，我們先把晚會的交流規劃好。若合作成案，蕎拉燕麥的品牌素材將在核可後，以合適方式陪伴這場新生相遇的時刻。', label: '貼文方向一｜活動前' },
  { image: 'assets/instagram/02-during.png', alt: '蕎拉燕麥 The Chala 合作貼文範例二', caption: '活動進行中，我們把安全與選擇放在第一位。感謝蕎拉燕麥支持指定商品合作的交流方向；現場依活動需求配置飲水與基本補給。', label: '貼文方向二｜活動中' },
  { image: 'assets/instagram/03-after.png', alt: '蕎拉燕麥 The Chala 合作貼文範例三', caption: '活動結束後，留下的不只是照片，也是一段對在地風味的認識。所有合作露出皆以蕎拉燕麥最終確認內容為準。', label: '貼文方向三｜活動後' },
];
let currentPost = 0;
