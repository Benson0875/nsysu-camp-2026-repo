...
const posts = [
  { image: 'assets/instagram/01-before.png', alt: '啤酒頭釀造 Taiwan Head Brewers 活動前實體合作物置入照片', caption: '迎新晚會前，我們想把節氣與在地食材的故事留一個位置給大家。若合作成案，品牌資訊將以核可內容呈現。', label: '貼文方向一｜活動前' },
  { image: 'assets/instagram/02-during.png', alt: '啤酒頭釀造 Taiwan Head Brewers 活動中實體合作物置入照片', caption: '活動中，讓對話從風味、創作與地方開始。任何含酒精安排僅限完成年齡確認的成年人，且不作為遊戲或競飲內容。', label: '貼文方向二｜活動中' },
  { image: 'assets/instagram/03-after.png', alt: '啤酒頭釀造 Taiwan Head Brewers 活動後實體合作物置入照片', caption: '這趟旅程結束後，秋日的記憶仍會延續。感謝啤酒頭釀造評估與新生團隊共創文化交流的可能。', label: '貼文方向三｜活動後' },
];
let currentPost = 0;
