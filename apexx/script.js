...
const posts = [
  { image: 'assets/instagram/01-before-apexx.png', alt: 'APEXX 合作貼文範例一', caption: '出發前，先把自己的風格準備好。APEXX 的貼紙與小物，陪五系新生把第一段校園騎行變得更有記憶點。', label: '貼文方向一｜活動前' },
  { image: 'assets/instagram/02-during-apexx.png', alt: 'APEXX 合作貼文範例二', caption: '中山的山路很多，每一次集合、移動與回程，都是新生活的一部分。感謝 APEXX 為新生的騎乘日常加上一點風格。', label: '貼文方向二｜活動中' },
  { image: 'assets/instagram/03-after-apexx.png', alt: 'APEXX 合作貼文範例三', caption: '三天兩夜結束了，新的校園生活才正要開始。期待 APEXX 陪五系新生騎出屬於自己的第一段路。', label: '貼文方向三｜活動後' },
];
let currentPost = 0;
...
window.apexxShowPost = (value, absolute = false) => renderPost(absolute ? value : currentPost + value);
