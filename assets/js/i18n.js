...
const en = {
  ...
  '一起尋找成就旅程的夥伴':'Seeking partners to make this journey possible', '完整合作資訊':'Full partnership details', '舒跑｜合作提案中':'Supau | Proposal in progress', '查看舒跑贊助合作提案':'View the Supau sponsorship proposal', '合作提案列表，可左右滑動':'Collaboration proposal list, scroll horizontally', '餐飲補給夥伴':'Food & refreshment partner', '校園友善店家':'Campus-friendly shop', '活動物資支持':'Event supplies partner', '影像紀錄夥伴':'Media documentation partner', '品牌合作夥伴':'Brand partnership partner',
