...
const en = {
  ...
  '感謝一起成就這趟旅程的夥伴':'Thanks to the partners who make this journey possible', '完整合作資訊':'Full partnership details', '舒跑｜活動補水夥伴':'Supau | Hydration partner', '活動補水夥伴':'Hydration partner', '魔爪｜活動能量夥伴':'Monster Energy | Energy partner', '活動能量夥伴':'Energy partner', '魔爪官方商標':'Monster Energy logo', '餐飲補給夥伴':'Food & refreshment partner', '校園友善店家':'Campus-friendly shop', '活動物資支持':'Event supplies partner', '影像紀錄夥伴':'Media documentation partner', '品牌合作夥伴':'Brand partnership partner',
