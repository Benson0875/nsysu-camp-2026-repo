...
const en = {
  ...
  '一群人一起闖關':'Take on challenges', '把陌生變成同一隊':'as one team', '混合小隊、團隊任務與學長姐陪伴，讓每一次笑聲、每一次互相幫忙，都變成認識彼此最自然的方式。':'Mixed-department teams, shared missions, and guidance from senior students make every laugh and helping hand a natural way to get to know one another.',
  ...
  '一起尋找成就旅程的夥伴':'Seeking partners to make this journey possible', '完整合作資訊':'Full partnership details', 'KOSO｜騎乘科技夥伴':'KOSO | Riding technology partner', '騎乘科技夥伴':'Riding technology partner', 'KOSO 官方商標':'KOSO logo', '前往 KOSO 官方網站，另開新分頁':'Visit the KOSO official website, opens in a new tab', '合作提案列表，可左右滑動':'Collaboration proposal list, scroll horizontally', '餐飲補給夥伴':'Food & refreshment partner', '校園友善店家':'Campus-friendly shop', '活動物資支持':'Event supplies partner', '影像紀錄夥伴':'Media documentation partner', '品牌合作夥伴':'Brand partnership partner',
  '用活動讓陌生變熟':'Get to know each other', '讓五系變成同一隊':'Five departments, one team', '從輕鬆的第一個招呼，到全力以赴的團隊挑戰，每一個活動都留有剛剛好的空間，讓你和新朋友一起參與。':'From a relaxed first hello to full-on team challenges, every activity leaves just the right space for you and new friends to join in.',
  ...
  '讓品牌成為':'Be part of', '新生回憶的一部分':'new memories', '五系聯合宿營集結跨系新生與工作團隊。從物資支援到現場互動，每一份合作都讓這趟旅程更完整。':'Our five-department camp brings together new students and the organizing team. From material support to on-site interaction, every partnership makes this journey more complete.', '合作提案中':'Proposals in progress', '活動物資':'Event supplies', '校園優惠':'Campus offers', '影像紀錄':'Media documentation', '周邊合作':'Merchandise partnership', '抽獎支持':'Raffle support',
  '合作提案情境示意：實際贊助品牌與素材將於合作確認後公布。':'Proposal mock-up: confirmed sponsor brands and materials will be announced after collaboration is finalized.', '期待品牌同行時刻':'A future moment alongside the brand', '我們正規劃適合活動節奏的補給與互動合作。合作確認後，將依品牌核可內容安排團隊合影與活動紀錄素材。':'We are planning support and interactive collaborations that fit the event. Once confirmed, team photos and event records will follow the approved brand materials.', '活動現場自然露出':'Natural on-site presence', '團隊合影素材紀錄':'Team photo documentation', '社群貼文延伸使用':'Extended social-post use', '一起把好感留在校園裡':'Leave a good impression on campus together', '合作店家與品牌可透過社群貼文、活動現場、手冊、物資與專屬優惠，和新生建立真實的第一印象。':'Partner businesses and brands can create a real first impression with new students through social posts, the event, handbooks, supplies, and exclusive offers.', '合作露出':'Partnership visibility', '網站、社群貼文、活動現場、手冊與工作團隊宣傳素材。':'Website, social posts, event presence, handbooks, and organizer promotional materials.', '店家資訊':'Business information', '店名、地址、營業時間、社群連結與活動期間優惠內容。':'Business name, address, opening hours, social links, and event-period offers.', '合作形式':'Partnership formats', '物資贊助、餐飲補給、折扣優惠、抽獎品與活動服務合作。':'Material sponsorship, food support, discounts, raffle prizes, and event-service partnerships.'
};
